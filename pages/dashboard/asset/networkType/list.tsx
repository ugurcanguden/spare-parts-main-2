...
import { CheckOutlined, CloseCircleOutlined, ProfileOutlined } from '@ant-design/icons';
import Add from './add';
...
export default function List() {
  ...
  const { baseUrl, deleteNetworkType } = NetworkTypeService();
  ...
  const columns = [  {
    ...
    {
      title: translate("networkTypePage.columns.name"),
      dataIndex: "name",
      key: "name",
    },
    {
      title: translate("networkTypePage.columns.utxO_Based"),
      dataIndex: "utxO_Based",
      key: "utxO_Based",
      render: (utxO_Based: boolean) => {
        return utxO_Based ? <CheckOutlined /> : <CloseCircleOutlined />
      }
    },
    {
      dataIndex: 'id',
      ...
      <Space>
          ...
          <Popconfirm
            ...
            onConfirm={() => confirm(id,deleteNetworkType)}
