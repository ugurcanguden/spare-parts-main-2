...
export default function List() {
  ...
  const { baseUrl, deleteNetwork } = NetworkService();
  ...
  const columns = [    {
    ...
    {
      title: translate("networkPage.columns.name"),
      dataIndex: "name",
      key: "name",
    },
    {
      title: translate("networkPage.columns.symbol"),
      dataIndex: "symbol",
      key: "symbol" 
    },
    {
      ...
      <Space>
          ...
          <Popconfirm
            ...
            onConfirm={() => confirm(id,deleteNetwork)}
